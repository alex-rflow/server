...
// Вывод имени
@imagettftext($im, 20, 0, 1350, 40, $white, $path.'font/BebasNeue Regular.ttf',$UsersName);
// Вывод фамилии
@imagettftext($im, 20, 0, 1350, 60, $white, $path.'font/BebasNeue Regular.ttf',$UsersLastName);
//На этом все почти:)
// успешно загружено
