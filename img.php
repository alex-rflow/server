...
// Вывод имени
@imagettftext($im, 20, 0, 1336, 25, $white, $path.'font/BebasNeue Regular.ttf',$UsersName);
// Вывод фамилии
@imagettftext($im, 20, 0, 1336, 38, $white, $path.'font/BebasNeue Regular.ttf',$UsersLastName);
//На этом все почти:)
// успешно загружено
